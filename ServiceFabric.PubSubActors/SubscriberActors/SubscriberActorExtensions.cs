...
namespace ServiceFabric.PubSubActors.SubscriberActors
{
    ...
    public static class SubscriberActorExtensions
    {
        ...
        /// <param name="sourceBrokerActorId">
        /// (optional) The ID of the source <see cref="IBrokerActor"/> to use as the source for the <paramref name="relayBrokerActorId"/> Remember this
        /// ID in the caller, if you ever need to unregister. If not specified, the default <see cref="IBrokerActor"/> for the message type <paramref
        /// name="messageType"/> will be used.
        /// </param>
        /// <returns></returns>
        ...
        /// <param name="sourceBrokerActorId">
        /// (optional) The ID of the source <see cref="IBrokerActor"/> that was used as the source for the <paramref name="relayBrokerActorId"/> If not
        /// specified, the default <see cref="IBrokerActor"/> for the message type <paramref name="messageType"/> will be used.
        /// </param>
        ...
        public static TResult Deserialize<TResult>(this ActorBase actor, MessageWrapper message)
        {
            ...
            return message.UnwrapMessage<TResult>();
        }
